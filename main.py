...
def dash_func():
    ...
    def slide():
        global i 
        img2 = Image.open(f"Images\\Cars\\{lt[i]}")
    ...
    lt = os.listdir("Images\\Cars")
    img = Image.open(f"Images\\Cars\\{lt[0]}")
...
def rent_func():
    ...
    to_entry = DateEntry(m_frame, mindate=datetime.now().date() + timedelta(days=1), date_pattern="yyyy/mm/dd", font=("Arial", 15, "bold"), state="readonly")
...
def main_win():
    ...
    logo = Image.open(f"Images\\image.jpg")
...
bg_img = Image.open("Images\\rent.jpg")
